...
import com.toceansoft.sociallogin.oauth.OauthBaidu;
...
public class OauthBaiduController {
	...
	public String callback(HttpServletRequest request) {
		...
		// 获取用户信息
		try {
			JSONObject userInfo = oauthBaidu.getUserInfoByCode(code);
	...
	public String index(HttpServletRequest request, HttpServletResponse response) {
		...
		// state就是一个随机数，保证安全
		try {
			String url = oauthBaidu.getAuthorizeUrl(state);
			return "redirect:" + url;
