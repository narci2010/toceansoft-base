...
import com.toceansoft.sociallogin.oauth.OauthGithub;
...
public class OauthGithubController {
	...
	@Autowired
	private OauthGithub oauthGithub;
	...
	public String callback(HttpServletRequest request) {
		...
		// 获取用户信息
		try {
			JSONObject userInfo = oauthGithub.getUserInfoByCode(code);
	...
	public String index(HttpServletRequest request, HttpServletResponse response) {
		...
		// state就是一个随机数，保证安全
		try {
			String url = oauthGithub.getAuthorizeUrl(state);
			return "redirect:" + url;
